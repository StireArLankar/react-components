...
const leftTop = keyframes({
  ...
  '33%': { transform: `scale(0.9) translate(${-distX}px, 0)` },
  '62%': { transform: `scale(0.7) translate(${-distX}px, ${-distY}px)` },
...
const posVariants = styleVariants({
